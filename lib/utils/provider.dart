...
class Provider {
  ...
  Future<bool> checkTableIsRight() async {
    List<String> expectTables = ['cat', 'widgets', 'collection'];
  ...
  Future init(bool isCreate) async {
    ...
    bool tablesIsRight = await checkTableIsRight();
    ...
    if (!tablesIsRight) {
      ...
      // 资源加载,读取本地的db
      // https://stackoverflow.com/questions/53182480/how-to-get-a-flutter-uint8list-from-a-network-image
