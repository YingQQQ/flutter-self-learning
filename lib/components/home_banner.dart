...
class _BannerState extends State<HomeBanner> {
  ...
  Widget _buildItemTitle(String title) => Container(
  ...
  Widget _buildIndicator() {
    ...
    for (var i = 0; i < widget.bannerStories.length; i++) {
      indictors.add(Container(
        width: 6.0,
        height: 6.0,
        margin: const EdgeInsets.symmetric(horizontal: 1.5, vertical: 10.0),
        decoration: BoxDecoration(
